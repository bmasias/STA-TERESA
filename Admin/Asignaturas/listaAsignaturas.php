  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../dashboard.php">
        ...
        <div class="sidebar-brand-text mx-3">Sagrada <sup>Familia</sup></div>
      </a>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                $select ="SELECT * FROM asignaturas";
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <ttbody>
                    <?php
                      ...
                      ?>
                    <tr>
                      <td><?php echo $ver["id_asignaturas"]; ?></td>
                      <td><?php echo $ver["nom_asignatura"].' '.$ver["apellido"]; ?></td>
                      <td><a href="Editar.php?id=<?php echo $ver["id_asignaturas"];?>"><img src="../../img/edi.png"></a></td>
                      <td><a onclick="return confirm('Confirma que deseas borrar este registro.');" href="Eliminar.php?id=<?php echo $ver["id_asignaturas"];?>"><img src="../../img/eli.png"></td>
                    </tr>
                    <?php 
                    }
                    ?>
