                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <ttbody>
                    <?php
                      ...
                      ?>
                    <tr>
                      <td><?php echo $ver["id_curso"]; ?></td>
                      <td><?php echo $ver["nombre"].' '.$ver["apellido"]; ?></td>
                      <td><a href="Editar.php?id=<?php echo $ver["id_curso"];?>"><img src="../../img/edi.png"></a></td>
                      <td><a onclick="return confirm('Confirma que deseas borrar este registro.');" href="Eliminar.php?id=<?php echo $ver["id_curso"];?>"><img src="../../img/eli.png"></td>
                    </tr>
                    <?php 
                    }
                    ?>
