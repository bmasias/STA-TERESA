          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                $select ="SELECT u.rut_usu ,u.nombre ,u.apellido ,u.correo ,u.direccion,u.fono , tu.tipo as 'cargo'
                          FROM usuarios u , tipo_usuarios tu
                          WHERE (u.id_tipo = tu.id_tipo) AND u.estado='Activo' and tu.tipo='Profesor'";
